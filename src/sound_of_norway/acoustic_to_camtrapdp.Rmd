...
media <-
  ...
  dplyr::mutate(
    ...
    timestamp = .data$upload_time, # Required
    filePath = .data$audio_link,# Required
    filePublic = FALSE, # Required
    fileName = NULL,
    fileMediatype = "audio/mp3", # Required # MP3 format (VBR0 using FFMPEG’s LAME  codec) not in https://www.iana.org/assignments/media-types/audio/mpeg
